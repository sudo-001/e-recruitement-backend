...
- Candidate application and selection process using Genetic Algorithms and AHP
- Generation of candidate profiles using an AI model
- Handling of candidate CVs and application data
- Management of job offers
- Management of recruiter data
